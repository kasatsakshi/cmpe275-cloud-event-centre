  ...
  return (
    <div>
      ...
      <div className="event-container">
        ...
        <Button disabled={event.status !== "REGISTRATION_OPEN"} className="event-button" onClick={() => signupevents()}>Sign Up</Button>
        <Button className="event-button" onClick={() => signupevents()}>Signup Forum</Button>
        <Button className="event-button" onClick={() => signupevents()}>Participant Forum</Button>
      </div>
    </div>
  );
}
